...
\title{Wavelet-Domain Conditional Denoising Diffusion Probabilistic Models for Anatomically Plausible Counterfactual 3D Healthy Brain Tissue Reconstruction via Volumetric MRI Inpainting} 
\titlerunning{Wavelet Diffusion for 3D Healthy Brain Inpainting}
...
\and
Mostafa Mehdipour Ghazi\inst{3}\orcidID{0000-0002-8473-281X}
}
