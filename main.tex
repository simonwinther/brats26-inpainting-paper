...
\end{equation}
When $\sum_p w_p>0$, the implementation uses Eq.~\eqref{eq:training-objective}; if this support is zero, it assigns that example's regional term zero rather than adding an epsilon. Both terms exclude cells touching the real tumor.
