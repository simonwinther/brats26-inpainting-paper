...
\begin{figure}[!t]
  ...
  \caption{CATCH training and one-trajectory inference. A Haar transform maps the
  ...
  compositing restore the observed region. Selected random and weighted-mixture
  pipelines repeat this path five times and aggregate voxel-wise; fixed mask uses
  $N=1$. Thumbnails were selected without reconstruction metrics.}
